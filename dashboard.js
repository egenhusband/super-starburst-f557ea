...
const DASHBOARD_FUTURE_RAIL_URL = '/data/capital-future-rail.json?v=20260905route-anchors1';
...
function clearDashboardRailLayer() {
  dashboardApartmentMapState.railPolylines.forEach(line => line.setMap(null));
...
async function renderDashboardRailLayer() {
